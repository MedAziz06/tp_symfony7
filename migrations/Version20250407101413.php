 ...
 */
final class Version20250407101413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD id INT AUTO_INCREMENT NOT NULL, DROP category_id, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD category_id INT NOT NULL, DROP id');
